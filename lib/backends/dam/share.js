...
return this.protocol + '//' + this.host + ':' + this.port + this.contextPath + DAM.DAM_ROOT_PATH + encodeURI(utils.normalizeSMBFileName(utils.stripParentPath(this.path, this.contextPath + DAM.DAM_ROOT_PATH) + path));
};
...
DAMShare.prototype.fetchContent = function (tree, path, deep, cb) {
  ...
  var opts = this.applyRequestDefaults(tree, null, url);
