 ...
 */
DAMTree.prototype._open = function (name, cb) {
  // call base class method
  return JCRTree.prototype._open.call(this, name, cb);
};
 ...
 */
DAMTree.prototype._list = function (pattern, cb) {
  // call base class method
  return JCRTree.prototype._list.call(this, pattern, cb);
};
 ...
 */
DAMTree.prototype._createFile = function (name, cb) {
  JCRTree.prototype._createFile.call(this, name, cb);
};
 ...
 * @param {SMBError} cb.error error (non-null if an error occurred)
 */
DAMTree.prototype._delete = function (name, cb) {
  JCRTree.prototype._delete.call(this, name, cb);
};
 ...
 * @param {SMBError} cb.error error (non-null if an error occurred)
 */
DAMTree.prototype._deleteDirectory = function (name, cb) {
  JCRTree.prototype._deleteDirectory.call(this, name, cb);
};
 ...
 * @param {SMBError} cb.error error (non-null if an error occurred)
 */
DAMTree.prototype._rename = function (oldName, newName, cb) {
  var self = this;
  JCRTree.prototype._rename.call(this, oldName, newName, function (err) {
    if (err) {
      cb(err);
      return;
    }
 ...
 * @param {SMBError} cb.error error (non-null if an error occurred)
 */
DAMTree.prototype._refresh = function (folderPath, deep, cb) {
  // call base class method
  return JCRTree.prototype._refresh.call(this, folderPath, deep, cb);
};
