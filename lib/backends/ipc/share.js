...
var IPCTreeConnection = require('./treeconnection');
 ...
 * @param {IPCTreeConnection} cb.tree connected tree
 */
IPCShare.prototype.connect = function (session, shareLevelPassword, cb) {
  var self = this;
  process.nextTick(function () { cb(null, new IPCTreeConnection(self)); });
};
