...
JCRShare.prototype.resourceExists = function (tree, name, cb) {
  ...
  var options = this.applyRequestDefaults(tree, opts);
...
JCRShare.prototype.fetchResource = function (context, path, cb) {
  ...
  opts.headers[JCR.ACTION_HEADER] = JCR.ACTION_DOWNLOADFILE;

  var url = this.buildResourceUrl(path);
  var options = this.applyRequestDefaults(context, opts, url);
