...
JCRTree.prototype.createFile = function (name, cb) {
  ...
  opts.headers[JCR.ACTION_HEADER] = JCR.ACTION_CREATEFILE;

  var self = this;
  var options = this.share.applyRequestDefaults(self, opts);
...
JCRTree.prototype.delete = function (name, cb) {
  ...
  webutils.submitRequest(options, function (err, resp, body) {
    if (err) {
      ...
      // succeeded
      // invalidate cache
      self.share.invalidateContentCache(self, name, false);
      cb();
    }
  });
};
...
JCRTree.prototype.deleteDirectory = function (name, cb) {
  ...
  opts.headers[JCR.ACTION_HEADER] = JCR.ACTION_DELETEFOLDER;
  var options = this.share.applyRequestDefaults(this, opts);
  ...
  webutils.submitRequest(options, function (err, resp, body) {
    if (err) {
      ...
      // succeeded
      // invalidate cache
      self.share.invalidateContentCache(self, name, true);
      if (self.tempFilesTree) {
...
JCRTree.prototype.rename = function (oldName, newName, cb) {
  ...
  opts.headers[JCR.ACTION_HEADER] = JCR.ACTION_RENAME;
  var options = this.share.applyRequestDefaults(self, opts);
  webutils.submitRequest(options, function (err, resp, body) {
    if (err) {
