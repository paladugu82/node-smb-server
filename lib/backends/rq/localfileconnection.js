 ...
 */
var RQLocalFileConnection = function (tree, sourceFileConnection, cacheData) {
  if (!(this instanceof RQLocalFileConnection)) {
    return new RQLocalFileConnection(tree, sourceFileConnection, cacheData);
  }

  FileConnection.call(this, sourceFileConnection.getFilePath(), tree);
  this.sourceFileConnection = sourceFileConnection;
  this.cacheData = cacheData || {};
  this.dirty = sourceFileConnection.dirty ? true : false;
...
RQLocalFileConnection.prototype.createFile = function (tree) {
  return new RQLocalFile(this, this.sourceFileConnection.createFile(tree.getSourceTree()), tree);
};
...
RQLocalFileConnection.prototype.getCacheData = function () {
  // IMPORTANT NOTE: this method is used to determine whether a FileConnection instance is a RQLocalFileConnection or
  // not. Use great care if removing this function.
