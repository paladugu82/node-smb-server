...
var RQRemoteTreeConnection = function (share, content, tempFilesTree) {
  ...
  // purposely ignoring tempFilesTree here. The RQ backend merges its local cache with remote entries, so the local
  // cache will become what the tempFilesTree is in the DAM/JCR backend.
  DAMTreeConnection.call(this, share, content, null);
  this.share = share;
