 ...
 */
var File = function (fileConnection, tree) {
  if (!(this instanceof File)) {
    return new File(fileConnection, tree);
  }
  this.fileConnection = fileConnection;
  this.filePath = fileConnection.getFilePath();
  this.fileName = fileConnection.getName();
  this.tree = tree;
};
 ...
 */
File.prototype.getConfig = function () {
  return this.fileConnection.getConfig();
};

/**
 * Retrieves the context under which the file is running.
 * @returns {SMBContext}
 */
File.prototype.getContext = function () {
 ...
 * @returns {Object}
 */
File.prototype.getLogger = function () {
  return this.tree.getLogger();
};

/**
 * Retrieves the file's FileConnection instance.
 * @returns {FileConnection} A file connection.
 */
File.prototype.getFileConnection = function () {
