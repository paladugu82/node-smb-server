...
/**
 * Ensures that all separators in a given path are the correct character based on the operating system.
 * @param {String} path The path whose separators should be normalized.
 * @return {String} A path whose separators are all appropriate to the operating system.
 */
...
function unicodeNormalizeForm(str, form) {
  if (form && form.toLowerCase() == 'nfkc') {
    return unorm.nfkc(str);
  } else if (form && form.toLowerCase() == 'none') {
    return str;
  } else {
    return unorm.nfkd(str);
  }
...
function unicodeEqualsForm(str1, str2, form) {
  return unicodeNormalizeForm(str1, form) == unicodeNormalizeForm(str2, form);
}
...
module.exports.normalizePathSeparator = normalizePathSeparator;
...
module.exports.unicodeNormalizeForm = unicodeNormalizeForm;
module.exports.unicodeEquals = unicodeEquals;
module.exports.unicodeEqualsForm = unicodeEqualsForm;
